...
import com.example.uimode.activity.tree.DensityUtil;
import com.example.uimode.activity.tree.mode.FamilyMemberModel;
import com.example.uimode.activity.tree.wight.MeasureUtils;
...
//        }
    ...
    private void layoutView(PersonView personView) {
        ...
        personView.setImage(familyMemberModel. getTreeNodeEntity().getSex(), familyMemberModel. getTreeNodeEntity().getPicUrlString());
        personView.setTitle(familyMemberModel. getTreeNodeEntity().getName());
    }
